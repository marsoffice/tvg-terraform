...
resource "azuread_application" "application" {
  ...
  single_page_application {
    redirect_uris = var.include_localhost_redirect == true ? ["https://zikmash.127.0.0.1.nip.io/", "https://zikmash.127.0.0.1.nip.io:4200/", "https://localhost/", "https://localhost:4200/", "https://${var.redirect_url}/"] : ["https://${var.redirect_url}/"]
  }
